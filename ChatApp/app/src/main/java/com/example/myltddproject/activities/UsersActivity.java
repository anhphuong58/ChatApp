...
import com.example.myltddproject.R;
import com.example.myltddproject.adapters.UserAdapter;
import com.example.myltddproject.databinding.ActivityUsersBinding;
import com.example.myltddproject.listeners.UserListener;
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if(task.isSuccessful() && task.getResult()!= null){
                        ...
                        if(users.size()>0){
                            ...
                            binding.userRecyvlerView.setAdapter(userAdapter);
                            binding.userRecyvlerView.setVisibility(View.VISIBLE);
                        } else {
                            showErrorMessage();
                        }
